...
void UpdateFlipSAT(u8 mode)
{
	...
	case SAT_FLIP:   Print_DrawText("Flip\x10\x10"); break;
...
void main()
{
	...
	Print_DrawText("\x1\x2\x3\x5\x6   SPRITE MODE 1 (G2)\n");
	...
	// Load 8x8 sprites
	VDP_LoadSpritePattern(g_Font_CMSX_Symbol1 + 4 + (16 * 10 * 8), 0, PATTERN_8_NUM);
