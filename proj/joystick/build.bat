...
rem ***************************************************************************
SET ProjName=joystick
set SrcList=main.c,%LibDir%\src\bios_main.c,%LibDir%\src\video.c,%LibDir%\src\print.c,%LibDir%\src\joystick.c
set LibList=%OutDir%\main.rel %OutDir%\bios_main.rel %OutDir%\video.rel %OutDir%\print.rel %OutDir%\joystick.rel
rem  Target:
