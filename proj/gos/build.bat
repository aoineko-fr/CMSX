...
rem ***************************************************************************
SET ProjName=gos
set SrcList=%ProjName%.c,%LibDir%\src\bios_main.c,%LibDir%\src\vdp.c,%LibDir%\src\print.c,%LibDir%\src\msxi\msxi_unpack.c,%LibDir%\src\input.c,%LibDir%\src\memory.c
set LibList=%OutDir%\%ProjName%.rel %OutDir%\bios_main.rel %OutDir%\vdp.rel %OutDir%\print.rel %OutDir%\msxi_unpack.rel %OutDir%\input.rel %OutDir%\memory.rel
rem  Target:
