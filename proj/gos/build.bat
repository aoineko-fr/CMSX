...
rem ***************************************************************************
SET ProjName=gos
set SrcList=gos.c,%LibDir%\src\bios_main.c,%LibDir%\src\video.c,%LibDir%\src\print.c,%LibDir%\src\msxi\msxi_unpack.c,%LibDir%\src\joystick.c
set LibList=%OutDir%\gos.rel %OutDir%\bios_main.rel %OutDir%\video.rel %OutDir%\print.rel %OutDir%\msxi_unpack.rel %OutDir%\joystick.rel
rem  Target:
