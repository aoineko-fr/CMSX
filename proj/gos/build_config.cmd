...
rem ***************************************************************************
SET ProjName=gos
set SrcList=gos.c,%LibDir%\src\bios_main.c,%LibDir%\src\video.c,%LibDir%\src\font.c,%LibDir%\src\call_hl.s,%LibDir%\src\msxi\msxi_unpack.c
set LibList=%OutDir%\gos.rel %OutDir%\bios_main.rel %OutDir%\video.rel %OutDir%\font.rel %OutDir%\call_hl.rel %OutDir%\msxi_unpack.rel
rem  Target:
