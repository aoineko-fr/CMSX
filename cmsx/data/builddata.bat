...
%MSXi% -in font\font_cmsx_mini2.png    -out ..\src\font\font_cmsx_mini2.h    -pos 0 16  -size 8 6  -gap 0 2  -num 16 6  -trans 0x000000  -bpc 1  -name g_Font_CMSX_Mini2    -copy cmsx.txt -skip  -font 5 6 ! ~
%MSXi% -in font\font_cmsx_mini3.png    -out ..\src\font\font_cmsx_mini3.h    -pos 0 16  -size 8 6  -gap 0 2  -num 16 6  -trans 0x000000  -bpc 1  -name g_Font_CMSX_Mini3    -copy cmsx.txt -skip  -font 5 6 ! ~
...
%MSXi% -in font\font_cmsx_symbol1.png  -out ..\src\font\font_cmsx_symbol1.h  -pos 0 0   -size 8 8  -gap 0 0  -num 16 14 -trans 0x000000  -bpc 1  -name g_Font_CMSX_Symbol1  -copy cmsx.txt        -font 8 8 0x00 0xE0
%MSXi% -in font\font_tsm9900.png       -out ..\src\font\font_tsm9900.h       -pos 0 16  -size 8 8  -gap 0 0  -num 16 6  -trans 0x000000  -bpc 1  -name g_Font_TMS9900       -copy          -skip  -font 6 8 ! ~
